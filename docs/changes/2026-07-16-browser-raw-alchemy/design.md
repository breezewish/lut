...
- Full exports are sequential; fused color processing feeds bounded RGB16 strips to the Deflate TIFF writer without a full-size float or quantized intermediate.
