...
- The Worker passes the verified LUT bytes through the WASM bulk-array boundary; Rust validates UTF-8 and parses CUBE data without a browser-owned intermediate string.
