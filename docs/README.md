...
`docs/changes/2026-07-16-browser-raw-alchemy/` records the initial migration change and its implementation evidence. Product behavior belongs in `spec.md`, technical decisions in `design.md`, and one-sentence end-to-end cases in `test.md`.
