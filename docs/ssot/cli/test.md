...
- A real lossy DNG exports to a readable 256×168 RGB16 TIFF and reports corrected-v2 plus the pinned LibRaw version in JSON, including when the Linux destination path is not valid UTF-8.
