...
- Decoder capability routing selects the lazy pthread WASM only for patched independent-block decoders; sequential and uncompressed inputs remain on the regular single-thread build.
