...
- A main-branch GitHub Actions release gate uses short-lived OIDC credentials to start the dedicated T4, run all hardware WebGPU cases against the exact commit, and stop it before Pages deployment.
