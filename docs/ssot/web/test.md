...
- Output defaults to 16-bit TIFF, switches to Quality 95 JPEG through its labeled format selector, and keeps its single action disabled while the active RAW is decoding or its visible EV/white-balance/LUT recipe is waiting to render.
