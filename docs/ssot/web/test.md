...
- A 60-event EV burst scheduled at nominal 60 Hz in the production Chromium bundle paints at least 20 monotonically newer interaction frames, meets the first and final interaction latency budgets, and finishes with the exact current 1024px settled frame.
